...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 07 2020 г., 17:51
...
--
-- База данных: `watch_shop`
--
CREATE DATABASE IF NOT EXISTS `watch_shop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `watch_shop`;
...
(1, 'login', '$2y$10$3.EB01rs0jYkdnUJfdVpHOBDGHRHxyK.zSYbzvjq5rrTZ1fpYtHKe', 'mail@mail.ru', 'имя', 'addess', 'admin');
